      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)] border border-slate-200 p-8">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-sky-500 text-white py-3.5 rounded-xl font-bold hover:bg-sky-600 transition-all shadow-[0_4px_14px_0_rgba(14,165,233,0.39)] disabled:opacity-70 disabled:cursor-not-allowed"
          >
