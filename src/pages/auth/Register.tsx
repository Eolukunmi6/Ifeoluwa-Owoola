    ...
    <div className="min-h-[70vh] flex items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)] border border-slate-200 p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-500 text-[14px]">Join EduMatics as a parent</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-sky-500 text-white py-3.5 rounded-xl font-bold hover:bg-sky-600 transition-all shadow-[0_4px_14px_0_rgba(14,165,233,0.39)] disabled:opacity-70 disabled:cursor-not-allowed mt-4"
          >
